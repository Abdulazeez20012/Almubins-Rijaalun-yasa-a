...
const rawPoems = [
  {
    ...
    content: [
      ["Lii saadatun min hizihim # aqdaamuhum faoqal jibaa"], 
      ["inlam aqun min'um falii # Bihubihim hizzu wajaa"],
      ["Fabijaahihim wabihizihim # Toyyib lanaa ayshal ayaa"],
      ["Waqtim lanaa bil'hayril yaa # Man laa lanaa rabbu siwaa"],
      ["Yaa rabbanaa solli alaa # Khayril anaami man alaa"],
      ["Alaa samaawaatil ula # Bi izni rabbihil alii"],
      ["Tahni'atu rrabeehi # Bimidhati shafeehi"],
      ["Bil mantiqil baadihi # Abgii bihaa mu'amalii"],
      ["Ahlan bisha'ril maolidi # Sha'ril ulaa was su'dadi"],
      ["Sha'rin Nabiyyi Ahmadi # Sha'ri rabeehil awwali"],
      ["Qad uzzo bi-rabeehi # Iz kaana kaa rRobeehi"], 
      ["Lil ardi waa shefeehi # Bikulli khatbin mu'dili"],
      ["Ahlan bisha'ril farahi # Sha'ri zahaabi tarahi"], 
      ["Wa fakhrinaa wal marahi # Sha'rin Nabiyyil afdoli"],
      ["Sha'ril falaahi was-suruuri # Sha'ri bihi saada duhuuri"], 
      ["Muwashahi bayna shuhuuri # Mutawajin mukallali"],
      ["Ahlan bisha'ril faatihi # Iglaaqi kaonil faatihi"], 
      ["Man usso bil-fawaatihi # Wahaaza khatmal milali"],
      ["Ahlan bisha'ril khaatimi # Sha'ri nnabiyyi qosimi"], 
      ["Wafaatihi wa khatimi # Wa A'akhirin wa awwali"],
      ["Ahlan bisha'rin Naasiri # Lil-aqqi sha'ril A'amiri"], 
      ["Bil Urfi sha'ri Zohiri # Bikulli wasfin Akmal"],
      ["Ahlan bisha'ril haadi # Liman'aji Rashaadi"], 
      ["Wa qohidin wahaadii # Ilaa toreeqinl Amthali"],
      ["Ahlan bisha'ri seyyidi # Li-a'mari wa aswadi"], 
      ["Man haasa sabqo su'dadi # Yaoma i'tizaari rusuli"],
      ["Waqod kafaahaa kullahaa # A'baahahaa wakullaha"], 
      ["Biqaolihi Anaa lahaa # Inda 'ishtidaadil wajali"],
      ["Fayaa lahaa min khuto # Jawaabuhu fil ukhto"], 
      ["Min robbihi sal tu'to # Washfa'a ladaynaa tuqbalu"],
      ["Ahlan bisha'ril mustafaa # Sofwatu kullu mustofa"], 
      ["Wa khayri abdii qod sofaa # Min malikin ao mursalin"],
      ["Wa sha'ri khayril khalqi # Sha'ri jemeelul khalqi"], 
      ["Sha'ri azeemil khalqi # Fil mu'kamil munazzali"],
      ["Sha'ri ladhii Azarahu # Ilaahuhu wa'khtarahu"], 
      ["Min ubbihi khayyarahu # Hinda' inqido-ohil ajali"],
      ["Sha'ri llazzi maa saaha qottu # Waman lahul usnaa faqot"], 
      ["Alayhi jibreelun abati # Bikulli Nnuuri mu'tali"],
      ["Ahlan bilayli isnaa ashar # Feehi wayaomihi-l- agar"], 
      ["Wateebi zaalika sahar # Wanuuru Hufqihi-l-jeli"],
      ["Ahlan bikulli maa thohari # min khariqin yahyal fiqari]", 
        ["Feehi karofhihil basori # Ilaa maqo-omihil alii"],
      ["Wa maa rahathu min ajab # Aminatu heena nasob"], 
      ["Sabaabatan thuma iqtarab # Bisajdati-l-mubtahili"],
      ["Kama tadallaa Zuhuru # Kama taraa-al qos-ru"], 
      ["Feehi wahalla-l- kasru # Bi-sonomi-l- mujdali"],
      ["Wagaadoti-l-bihaaru # Wajaffati-l- anhaaru"], 
      ["Min ajlihi wan-naari # Qod tofi-at min khajali"],
      ["Wajinnuhum fee nakadin # Laram-yihaa bi-rosodi"], 
      ["Wa-azlihaa an moghadi # Min ajli khayri rusuli"],
      ["Waran-natu shaytaani # Jazaa azeemu sha'ani"], 
      ["Min ao-dohil burhaani # Li-azmi maa bihib-tuli"],
      ["Qod manna dhul-ifdoli # Bi-afdoli rijaali"], 
      ["Fil afdoli layaalii # Bil-baladil mufadoli"],
      ["Ahlan biyaomi heedin # Maa mizluhu min heedin"], 
      ["Qod alla fil maolidi # Feehi mahalla zuhalin"],
      ["Wasaa-bihil - wilaada # wamaa ataahu saa-da"], 
      ["Min wifqin maa araada # ilaa-huhu fil azali"],
      ["Ahlan biyaomi summii # Muhammadan khayras-smin"], 
      ["Ramsan lima'na-l-ismi # Min jaddihi layanjali"],
      ["Bihamdi-l-Awwaleena # Lahu wal-haakhireena"], 
      ["Fakaana zaa yekeenaa # Minal kareemil mufdoli"],
      ["Ahlan biyaomi iznayni # Maolidi zaani-iznayni"], 
      ["Mabhazu sirril-kaoni # Moq-damihil mubajjali"],
      ["Akrim bi-sha'ril hajami # Ibreela sha'ril karami"], 
      ["Akrim bi-ardil harami # Maolidi khayri mursali"],
      ["Akrim biyaomin so-oraa # Ishreena was-tano-oran"],
      ["Liman hawaa-s-tano-oraa # Wagufratun min monzili"],
      ["Akrim bisha'ri Neesaani # Maolidi khayri insaani"], 
      ["Qudwati A'alil ihisaani # Wal kaamilil mukammali"],
      ["Qod tammati laa-haali # Fee uddati laayaalee"], 
      ["Bizeenatil mahaalii # Kal-jaoharil mufadoli"],
      ["Ta'nihatun robeehi # Bimid-hati shaafeehi"], 
      ["Bil-mantiqil badeehi # Abgii biha muhammali"],
      ["Abgii bihaal jamha bihi # Yaoman wanayla qurbihi]", 
        ["Wafadli hubbi Robbihi # Waman rido-ohu amalii"],
      ["Wal-khatma lee bil-husnaa # Wal-jamha lee fil husnaa]", 
        ["Ladaal moqo-oril usnaa # Mahaa rofeeqi-l-afdoli"],
      ["Wakun lanaa waleeyan # Wan-naasiran hafiyan"], 
      ["Laa-na'khtashi gawiyyan # Bijaahi abdeekal-allee"],
      ["Solli wasallama -l- ilaa` # Alayhi afdolu solaata"], 
      ["Maa daama kaonuhu illaa # Min abada li-asali"],
      ["Wa-haalihi wasahbihi # Wasaojihi wa hisbihi"], 
      ["Wakulli aali khubbihi # Maha salaamil akmali"],
      ["Bijaahihim yaa ilaahi igfir linaasimihaa # Wasma' liqohreeha walillazii hadora]", 
      ["Wahumahum bikhafiyin lutfi wakfihim # Nawaa-hiba d-dahri maha aafaatihil kadara"],
